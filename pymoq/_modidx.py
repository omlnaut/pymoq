...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'pymoq.argument_validators': { 'pymoq.argument_validators.ArgumentFunctionValidator': ( 'validators.html#argumentfunctionvalidator',
                                           ...
                                           'pymoq.argument_validators.ArgumentFunctionValidator.__init__': ( 'validators.html#__init__',
                                                                                                             'pymoq/argument_validators.py'),
                                           'pymoq.argument_validators.ArgumentFunctionValidator.is_valid': ( 'validators.html#is_valid',
                                                                                                             'pymoq/argument_validators.py'),
