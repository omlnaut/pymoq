...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'pymoq.argument_validators': { 'pymoq.argument_validators.ArgumentFunctionValidator': ( 'validators.html#argumentfunctionvalidator',
            ...
            'pymoq.mocking.functions': { 'pymoq.mocking.functions.FlaggedReturn': ( 'mocking.functions.html#flaggedreturn',
                                                                                    'pymoq/mocking/functions.py'),
                                         'pymoq.mocking.functions.FlaggedReturn.__init__': ( 'mocking.functions.html#flaggedreturn.__init__',
                                                                                             'pymoq/mocking/functions.py'),
                                         'pymoq.mocking.functions.FunctionMock': ( 'mocking.functions.html#functionmock',
                                                                                   'pymoq/mocking/functions.py'),
