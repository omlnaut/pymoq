  ...
  'syms': { 'pymoq.argument_validators': { 'pymoq.argument_validators.ArgumentFunctionValidator': ( 'validators.html#argumentfunctionvalidator',
            ...
            'pymoq.signature_validators': { 'pymoq.signature_validators.SignatureValidator': ( 'signature_validators.html#signaturevalidator',
                                            ...
                                            'pymoq.signature_validators.signature_validator_from_arguments': ( 'signature_validators.html#signature_validator_from_arguments',
                                                                                                               'pymoq/signature_validators.py')},
            'pymoq.verification': { 'pymoq.verification.FunctionMock.verify': ('verfiy.html#functionmock.verify', 'pymoq/verification.py'),
                                    'pymoq.verification.VerifiedCalls': ('verfiy.html#verifiedcalls', 'pymoq/verification.py'),
                                    'pymoq.verification.VerifiedCalls._build_error_msg': ( 'verfiy.html#verifiedcalls._build_error_msg',
                                                                                           'pymoq/verification.py'),
                                    'pymoq.verification.VerifiedCalls.more_than': ( 'verfiy.html#verifiedcalls.more_than',
                                                                                    'pymoq/verification.py'),
                                    'pymoq.verification.VerifiedCalls.never': ('verfiy.html#verifiedcalls.never', 'pymoq/verification.py'),
                                    'pymoq.verification.VerifiedCalls.times': ('verfiy.html#verifiedcalls.times', 'pymoq/verification.py'),
                                    'pymoq.verification.VerifiedCalls.verified': ( 'verfiy.html#verifiedcalls.verified',
                                                                                   'pymoq/verification.py')}}}